...
import com.neefull.fsp.web.system.service.IDeptService;
...
public class DeptController {
    ...
    @Log("新增部门")
    @PostMapping
    @RequiresPermissions("qf:dept:add")
    ...
    @RequiresPermissions("qf:dept:delete")
    ...
    @Log("修改部门")
    @PostMapping("update")
    @RequiresPermissions("qf:dept:update")
    ...
    @GetMapping("excel")
    @RequiresPermissions("qf:dept:export")
